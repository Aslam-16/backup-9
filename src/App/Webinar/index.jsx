  ...
  <div class="panel panel-default">
    <div class="panel-heading" role="tab" id="headingTwo">
      <h4 class="panel-title">
        <a  style={{paddingBottom: 22}}class="accordion-toggle collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
          <span>Webinar on Full Stack Development</span>
         <p class="presenter" style={{
    paddingTop: 5,color:"black",marginBottom: 0
}}>by Aslam,Ceo, Mytech services Alaska</p>
 ...
 <div style={{paddingLeft:700,marginTop:-38}}><button  type="button" class="click">Register Now</button></div>
  ...
  <div class="panel panel-default">
    <div class="panel-heading" role="tab" id="headingThree">
      <h4 class="panel-title">
        <a style={{paddingBottom: 22}}class="accordion-toggle collapsed"  role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
          <span>Webinar on Full Stack Development</span>
         <p class="presenter" style={{
    paddingTop: 5,color:"black",marginBottom: 0
}}>by Aslam,Ceo, Mytech services Alaska</p>
